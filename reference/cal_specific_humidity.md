...
Calculate specific humidity \\q\\ (g/kg) from vapor pressure \\e\\ (hPa)
and air pressure \\p\\ (hPa).

## Usage

``` r
cal_specific_humidity(e, p)
```
...
Numeric value of specific humidity in g/kg.

## Details

Specific humidity \\q\\ (g/kg) is defined as the mass of moisture per
mass of air:

\$\$q = \frac{0.622 \cdot e \cdot 1000}{p - 0.378 \cdot e}\$\$
